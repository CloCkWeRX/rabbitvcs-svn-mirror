...
if getpass.getuser() != "root":
	...
	shutil.move("./nautilussvn/usr/lib/nautilus/extensions-1.0/python/%s/copyright"%VERSION, "./nautilussvn/DEBIAN/")
	...
	ReplaceLineInFile(	"./nautilussvn/DEBIAN/postinst",
						'sudo ln -s /usr/lib/nautilus',
						'sudo ln -s /usr/lib/nautilus/extensions-1.0/python/%s/NautilusSvn.py /usr/lib/nautilus/extensions-1.0/python/NautilusSvn.py\n'%VERSION
					)
